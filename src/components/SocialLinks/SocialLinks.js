...
class Component extends React.PureComponent {
    ...
    render() {
        const { theme, classes, energy, audio, sounds, className, itemClassName, animateY, onEnter, onExit, onLinkStart, onLinkEnd, ...etc } = this.props;
        const a = elprops => (
            <Link className={cx(classes.item, itemClassName)}
        ...
        return (
            <div className={cx(classes.root, className)} ref={ref => (this.element = ref)} {...etc} >
                <a href='https://www.facebook.com/jason.xie.7771586' title='Facebook' target='facebook'>
                    <span className='mdi mdi-facebook'/>
                </a>
                <a href='mailto:jason.xie@victheme.com' title='Email' target='email'>
