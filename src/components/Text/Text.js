...
class Component extends React.PureComponent {
    ...
    animateTransition(isEntering) {
        ...
        const onCall = ({ timeProgress }) => {
            ...
            const newText = children && children.substring && children.substring(0, newLength);
    ...
    render() {
        ...
        return (
            <span className={cls} {...etc}>
                ...
                {animating && (<span className={classes.overlay}><span className={classes.overlayText} ref={ref => (this.overlayTextElement = ref)}/></span>)}
            </span>
        );
    }
}
